...
while True:
    ...
    while i >= 1:
        ...
        if a > n:
            ...
            print(" \nChal beta tune wo number dhoond liye.bhot shana hai re tu.mubarak bhai")
            print("Tuze", g, "chances lage dhundane me.Agli bar kaam lagne chaiye samja kya lapadjhandis")
            break
